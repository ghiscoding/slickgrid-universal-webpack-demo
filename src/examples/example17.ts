...
export default class Example17 {
  ...
  toggleGroup() {
    this.sgb1.dataView?.getGrouping() && this.sgb1.dataView?.getGrouping().length > 0
      ? this.sgb1.dataView?.setGrouping([])
      : this.groupByDuration1();
    this.sgb2.dataView?.getGrouping() && this.sgb2.dataView?.getGrouping().length > 0
      ? this.sgb2.dataView?.setGrouping([])
